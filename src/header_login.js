  ...
  render() {
      return (
		...
		<table align="center" width="90%">
			...
			<td style={{width: "15%"}}><Link to="/petyourself-reactjs/about"> About Us </Link></td>
			<td style={{width: "15%"}}><Link to="/petyourself-reactjs/shop1">Shop </Link></td>
			<td style={{width: "15%"}}><Link to="/petyourself-reactjs/testimoni">Testimoni</Link></td>
