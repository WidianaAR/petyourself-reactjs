      ...
      return (
        <div id='isi_about'>
			<table width="80%" align="center">
				...
				<tr>
					<td style={{"text-align": "center", "padding-bottom": "50px"}} width="65%" align="center"><Link to="/petyourself-reactjs"><button id="tombol" style={{width: "80%"}}>Beli sekarang!</button></Link></td>
				</tr>
			</table>
		</div>
      );
